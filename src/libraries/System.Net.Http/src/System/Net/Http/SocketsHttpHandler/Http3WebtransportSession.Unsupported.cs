...
namespace System.Net.Http
{
    ...
    public class Http3WebtransportSession : IAsyncDisposable, IDisposable
    {
        ...
        public System.Threading.Tasks.ValueTask<QuicStream> AcceptInboundStreamAsync(CancellationToken cancellationToken = default) => throw new PlatformNotSupportedException();
        public bool TryAcceptInboundStreamAsync(out System.Net.Quic.QuicStream? quicStream) => throw new PlatformNotSupportedException();
        ...
        public ValueTask<QuicStream> OpenOutboundStreamAsync(QuicStreamType type, CancellationToken cancellationToken = default) => throw new PlatformNotSupportedException();
